...
keytool -genkeypair -v -storetype PKCS12 \
  -keystore forextradehub-release.keystore \
  -alias forextradehub -keyalg RSA -keysize 2048 -validity 10000
```

Then in `android/gradle.properties` (never commit this):

```properties
FOREXTRADEHUB_UPLOAD_STORE_FILE=forextradehub-release.keystore
FOREXTRADEHUB_UPLOAD_KEY_ALIAS=forextradehub
FOREXTRADEHUB_UPLOAD_STORE_PASSWORD=…
FOREXTRADEHUB_UPLOAD_KEY_PASSWORD=…
```
