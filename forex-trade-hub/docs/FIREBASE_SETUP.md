...
2. Name it (e.g. `forextradehub-prod`), enable Google Analytics (needed for Crashlytics
...
Consider a second project (`forextradehub-dev`) and switch with `firebase use`.
...
- Package name: `com.forextradehub.app` (must match `APP_BUNDLE_ID`)
