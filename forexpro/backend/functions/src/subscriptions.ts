...
const APPLE_BUNDLE_ID = defineString('APPLE_BUNDLE_ID', { default: 'com.fxpulse.app' });
const ANDROID_PACKAGE_NAME = defineString('ANDROID_PACKAGE_NAME', { default: 'com.fxpulse.app' });
